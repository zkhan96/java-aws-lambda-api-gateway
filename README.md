...
You can find your API Gateway Endpoint URL in the responseGreeting values displayed after deployment.
...
Test a single function by invoking it directly with a test event. An event is a JSON document that represents the nameRequest that the function receives from the event source. Test events are included in the `events` folder in this project.
